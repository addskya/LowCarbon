...
public class ArcProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        this.finishedStrokeColor = attributes.getColor(styleable.ArcProgress_arc_finished_color, -1);
        this.unfinishedStrokeColor = attributes.getColor(styleable.ArcProgress_arc_unfinished_color, this.default_unfinished_color);
        this.textColor = attributes.getColor(styleable.ArcProgress_arc_text_color, this.default_text_color);
        this.textSize = attributes.getDimension(styleable.ArcProgress_arc_text_size, this.default_text_size);
        this.arcAngle = attributes.getFloat(styleable.ArcProgress_arc_angle, 288.0F);
        this.setMax(attributes.getInt(styleable.ArcProgress_arc_max, 100));
        this.setProgress(attributes.getInt(styleable.ArcProgress_arc_progress, 0));
        this.strokeWidth = attributes.getDimension(styleable.ArcProgress_arc_stroke_width, this.default_stroke_width);
        this.suffixTextSize = attributes.getDimension(styleable.ArcProgress_arc_suffix_text_size, this.default_suffix_text_size);
        this.suffixText = TextUtils.isEmpty(attributes.getString(styleable.ArcProgress_arc_suffix_text))?this.default_suffix_text:attributes.getString(styleable.ArcProgress_arc_suffix_text);
        this.suffixTextPadding = attributes.getDimension(styleable.ArcProgress_arc_suffix_text_padding, this.default_suffix_padding);
        this.bottomTextSize = attributes.getDimension(styleable.ArcProgress_arc_bottom_text_size, this.default_bottom_text_size);
        this.bottomText = attributes.getString(styleable.ArcProgress_arc_bottom_text);
    }
...
//        this.paint.setStrokeCap(Cap.ROUND);
    ...
    private int internalStrokeWidth = 20;
    private int dashWith = 5;
    private int dashSpace = 20;
    protected void onDraw(Canvas canvas) {
        ...
        this.paint.setAntiAlias(true);
        this.paint.setStrokeWidth(internalStrokeWidth);
        this.paint.setStyle(Paint.Style.STROKE);
        this.paint.setPathEffect(new DashPathEffect(new float[]{dashWith, dashSpace},
                dashSpace));
